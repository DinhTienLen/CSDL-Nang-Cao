...
/*
- cau 1
- Tạo thủ tục Pro_Salary để xét thưởng cuối năm như sau:
+ Nếu nv làm vc trên >=9 thưởng 12tr
+ Nếu nv làm vc trên >=6 thưởng 8tr
+ Nếu nv làm vc trên >=4 thưởng 6tr
+ Còn lại thưởng 5tr */
delimiter $$
create procedure pro_Salary()
begin
select first_name,last_name, timestampdiff(year, hire_date,now()) as 'nam',
case
...
*/
delimiter $$ 
create procedure Pro_Search_name (first_name varchar(20))
begin
